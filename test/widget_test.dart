...
void main() {
  ...
  group('LocalAppStore', () {
    ...
    test('文本恢复会使用导入时保存的基础分段快照', () async {
      ...
      expect(book.customChunks, const ['第一章。第二章。', '第三章。']);
      expect(book.initialChunks, const ['第一章。第二章。', '第三章。']);
